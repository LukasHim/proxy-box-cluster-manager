/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 4032398e707a85cf296e4ecce57a36cd)
// Runtime types generated with workerd@1.20260210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "CommandCenter";
	}
	interface Env {
		ASSETS: Fetcher;
		COMMAND_CENTER: DurableObjectNamespace<import("./src/worker").CommandCenter>;
